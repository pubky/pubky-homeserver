...
use crate::services::file_service::writes::{CommitWriteError, WriteMode, WriteOutcome};
use crate::{
...
async fn test_stale_write_preconditions_reject_before_upload() {
    ...
    let pending_blobs: i64 = sqlx::query_scalar("SELECT COUNT(*) FROM unreferenced_blobs")
