...
mod test_support {
    ...
    pub(super) fn test_finalizer(db: &SqlDb) -> Finalizer {
        Finalizer::new(
    ...
    pub(super) fn test_operator(db: &SqlDb) -> opendal::Operator {
    ...
    pub(super) async fn create_user(db: &SqlDb) -> pubky_common::crypto::PublicKey {
    ...
    pub(super) async fn user_usage(db: &SqlDb, pubkey: &pubky_common::crypto::PublicKey) -> u64 {
    ...
    pub(super) async fn all_events(db: &SqlDb) -> Vec<EventEntity> {
